...
#define OUTPUT 0
#define OUTPUT_Charge 1
#define OUTPUT_Filtered_Charge 1
...
// Modify
        if (n1 > 1 &&
           ...
           n5 > 0 &&
           ((static_cast<double>(chargeSum3) / n3) + (static_cast<double>(chargeSum2) / n2))  > 65 &&
           ((static_cast<double>(chargeSum1) / n1) + (static_cast<double>(chargeSum2) / n2))  > 65 &&
           ((static_cast<double>(chargeSum3) / n3) + (static_cast<double>(chargeSum4) / n4))  > 65 &&
           ((static_cast<double>(chargeSum1) / n1) + (static_cast<double>(chargeSum4) / n4))  > 65 &&
           ((static_cast<double>(chargeSum2) / n2) + (static_cast<double>(chargeSum4) / n4))  > 65 
) 
/*         if (
            n2 > 1 &&
            n4 > 1 &&
...

{
        ...
        if (!filteredFile.is_open()) {
            ...
            double normCharge1 = (n1 > 0) ? (double)chargeSum1 / n1 : 0;
            double normCharge2 = (n2 > 0) ? (double)chargeSum2 / n2 : 0;
            double normCharge3 = (n3 > 0) ? (double)chargeSum3 / n3 : 0;
            double normCharge4 = (n4 > 0) ? (double)chargeSum4 / n4 : 0;

            filteredFile << std::fixed << std::setprecision(4) << std::setw(10) << normCharge1 << ","
                        << std::setw(10) << normCharge2 << ","
                        << std::setw(10) << normCharge3 << ","
                        << std::setw(10) << normCharge4 << "\n";
            filteredFile.close();
