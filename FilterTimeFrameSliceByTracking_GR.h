/**
 * @file FilterTimeFrameSliceByTracking_GR.h
 * @brief Header file for FilterTimeFrameSliceByTracking_GR class
 ...
 */
#ifndef NESTDAQ_TIMEFRAMESLICERBYTRACKING_GR_H
#define NESTDAQ_TIMEFRAMESLICERBYTRACKING_GR_H
...
namespace nestdaq {
   class FilterTimeFrameSliceByTracking_GR;
}

class nestdaq::FilterTimeFrameSliceByTracking_GR : public nestdaq::FilterTimeFrameSliceABC {
public:
   FilterTimeFrameSliceByTracking_GR();
   virtual ~FilterTimeFrameSliceByTracking_GR() override = default;
...
#endif  // NESTDAQ_TIMEFRAMESLICERBYTRACKING_GR_H
